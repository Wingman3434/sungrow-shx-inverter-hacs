...
- Entity categories follow the Home Assistant review guide: measurements stay uncategorised, settings are `CONFIG`, and capability, version and raw-register data is `DIAGNOSTIC`.
