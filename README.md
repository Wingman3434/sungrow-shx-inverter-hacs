...
- Entity categories follow the Home Assistant review guide: measurements stay
  uncategorised, settings are Configuration, and version, capability and
  raw-register data is Diagnostic.
